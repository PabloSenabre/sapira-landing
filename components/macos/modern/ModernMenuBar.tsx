...
export default function ModernMenuBar({ activeApp, onNavigate }: ModernMenuBarProps) {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(updateMenuBarBounds, 200);
    ...
    return () => {
      ...
      liquidGlass.unregisterElement("modern-menubar");
    };
  ...
  // Color definitions based on theme - FIXED for proper contrast
  const colors = {
  ...
  return (
    <motion.div
      ...
      style={{
        // Always use backdrop blur with proper background - no transparent option
        background: isLight
    ...
    >
      ...
      <div className="flex items-center h-full gap-px">
        ...
        {/* Active App Name (Bold) - macOS style */}
        <motion.button
      ...
      {/* Right side - System Status Icons (macOS authentic spacing) */}
      <div className="flex items-center h-full">
        {/* Theme Toggle - Sun/Moon */}
        <motion.button 
          className="h-[22px] w-[28px] mx-0.5 flex items-center justify-center transition-all duration-150"
          style={getItemStyle("theme")}
        ...
        {/* Date & Time - macOS authentic styling */}
        <div 
